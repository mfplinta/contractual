...
This project is licensed under the **MIT** license. See [here](License.md) for details.

For commercial tailoring and support, please contact [me@plinta.dev](mailto:me@plinta.dev).
